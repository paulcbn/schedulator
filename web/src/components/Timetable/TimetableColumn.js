...
const TimetableEntry = ({ referenceStart, referenceEnd, positionedEntry, onClick }) => {
  const { subjectAlias, startTime, endTime, overlapSize, overlapIndex, subjectName, subjectComponentType, roomName } = useMemo(() => ({
...
const TimetableColumn = ({ referenceStart, referenceEnd, rawEntries, currentParity, onClickEntry }) => {
